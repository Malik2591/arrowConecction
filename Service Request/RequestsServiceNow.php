...
class RequestsServiceNow {
    private $lob;        //Tengo duda 01
    private $msgID;      //Tengo duda 02
    private $svcOrderReqNumber;
    private $svcOrderNumber;
    private $svcOrderReferenceNumber;
    private $svcOrderType;       //Tengo duda 03
    ...
    // Getters
    public function getLob() {   //Tengo duda 01
        return $this->lob;
    }
    public function getMsgID() {   //Tengo duda 02
        return $this->msgID;
    }
    ...
    public function getSvcOrderType() {   //Tengo duda 03
    ...
    public function getAddresses() {   //Duda 04
